...
const Feature = () => {
    return (
        <div id='fitur' className='w-full h-full relative bg-white'>
            ...
            <div className='max-w-[1240px] m-auto'>
                <div className='flex flex-row mt-[204px] md:flex-row xs:flex-col-reverse justify-between xs:items-center'> 
                    <div  className='md:flex md:mt-0 xs:mt-5'>
                        <img src="/hp2.png" alt="/"/>
                    </div>
                    <div className=''>
                ...
                <div className='flex flex-row md:flex-row xs:flex-col xs:items-center justify-between'>
                    <div className='mt-[266px]'>
                        <h4 className='font-display font-medium text-[#E38064] text-xl'>Fitur Unggulan</h4>
                        <h1 className='text-6xl mt-5 font-body'>RSVP</h1>
                    ...
                    <img src="/hp3.png" className='mt-[180px]'/>
                </div>
                <div className='flex flex-row mt-[204px] justify-between md:flex-row xs:flex-col-reverse xs:items-center'> 
                    <div>
